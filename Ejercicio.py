...
def actualizar_estudiante():
    ...
    if 0 <= indice < len(estudiantes):
        ...
        nuevo_nombre = input(f"Ingresa el nuevo nombre para {estudiante['nombre']} (o presiona Enter para no cambiarlo): ")
        nueva_edad = input(f"Ingresa la nueva edad para {estudiante['edad']} (o presiona Enter para no cambiarla): ")
        if nuevo_nombre:
